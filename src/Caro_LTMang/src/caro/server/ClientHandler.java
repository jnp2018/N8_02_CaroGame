        ...
        void ReceiveMessage(KMessage msg) throws IOException {
            ...
            switch (msg.getType()) {
                case 0: {
                    ...
                    user = new Users(1,temp.getUsername());
                    if(user != null)
                    {
                        Boolean flag = true;
                ...
                case 22:{
                    CRoom croom = (CRoom) msg.getObject();          
                    Main.lstRoom.add(new Room(Main.lstRoom.size(),croom.getSo_quan_thang(),croom.isChan_2_dau(),croom.getTime()));
                    break;
                }
                case 28:
                {
